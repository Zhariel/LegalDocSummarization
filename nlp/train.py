...
def train_model(sentences_path: str, tags_path: str):
    ...
    for i in range(len(docs)):
        current_doc = docs[i][1]
        if (docs[i][1]=="a") or (docs[i][1]=="a1") or (docs[i][1]=="a2") or (docs[i][1]=="a3") :
            a_set.append([bag_of_words(docs[i][0]),'a'])

        if (docs[i][1]=="ch") or (docs[i][1]=="ch1")  or (docs[i][1]=="ch2") or (docs[i][1]=="ch3") :
            ch_set.append([bag_of_words(docs[i][0]),'ch'])

        if (docs[i][1]=="j") or (docs[i][1]=="j1") or (docs[i][1]=="j2") or (docs[i][1]=="j2") :
            j_set.append([bag_of_words(docs[i][0]),'j'])

        if (docs[i][1]=="law") or (docs[i][1]=="law1")or (docs[i][1]=="law2")or  (docs[i][1]=="law3"): 
            law_set.append([bag_of_words(docs[i][0]),'law'])

        if (docs[i][1]=="ltd") or (docs[i][1]=="ltd1") or (docs[i][1]=="ltd2")or  (docs[i][1]=="ltd3"):
            ltd_set.append([bag_of_words(docs[i][0]),'ltd'])

        if (docs[i][1]=="ter")or (docs[i][1]=="ter1")or (docs[i][1]=="ter2") or (docs[i][1]=="ter3"):
            ter_set.append([bag_of_words(docs[i][0]),'ter'])

        if (docs[i][1]=="use") or (docs[i][1]=="use1") or (docs[i][1]=="use2") or (docs[i][1]=="use3"):
...
#doc_analysis("phrase.txt",classifier1)